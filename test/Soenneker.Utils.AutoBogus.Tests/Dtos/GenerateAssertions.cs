...
public sealed class GenerateAssertions : ReferenceTypeAssertions<object, GenerateAssertions>
{
    ...
    private static string AssertGuid(string path, Type type, object value) => value != null && Guid.TryParse(value.ToString(), out Guid result) && result != default ? null : GetAssertionMessage(path, type, value);
    private static string AssertInt(string path, Type type, object value) => value != null && int.TryParse(value.ToString(), out int result) && result != default ? null : GetAssertionMessage(path, type, value);
    ...
    private static string AssertLong(string path, Type type, object value) => value != null && long.TryParse(value.ToString(), out long result) && result != default ? null : GetAssertionMessage(path, type, value);
    ...
    private static string AssertUInt(string path, Type type, object value) => value != null && uint.TryParse(value.ToString(), out uint result) && result != default ? null : GetAssertionMessage(path, type, value);
    private static string AssertULong(string path, Type type, object value) => value != null && ulong.TryParse(value.ToString(), out ulong result) && result != default ? null : GetAssertionMessage(path, type, value);
